    ...
    if(!empty($email) && !empty($city) && !empty($name) && !empty($subject) && !empty($message)){
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
            ...
            $htmlContent = '<h2>Via Form Kontak Website</h2>
                ...
                <h5>Nama Pesanan</h5><p>'.$subject.'</p>
  ...
  <body>
    ...
    <div class="container">
        <form id="contact" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <?php } ?>
            <center><h3>Order Product & Services here!</h3><center>
            <fieldset>
                <input placeholder="Your name" type="text" name="name" tabindex="1" required autofocus>
            </fieldset>
      <select id="kota" name="city" class="form-control">
                            <option>--Location--</option>
                            <option>Manisi (Cibiru)</option>
                            <option>Cipadung</option>
                            <option>Batujajar</option>
                            <option>Cimahi</option>
                            <option>Batujajar Barat</option>
                            <option>Cileunyi</option>
            </select>
      <br>
            <fieldset>
                <input placeholder="Your email" type="text" name="email" tabindex="2" required>
            </fieldset>
            <fieldset>
                <input placeholder="Order name" type="text" name="subject" tabindex="4" required>
            </fieldset>
            <fieldset>
                <textarea placeholder="Write your message here!" name="message" tabindex="5" required></textarea>
            </fieldset>
            <fieldset>
